...
export interface DailyIadeChartData {
  date: string;
...
export function TrendChart({ data }: { data: DailyIadeChartData[] }) {
  return (
    <Card className="border-border/50">
      <CardHeader className="pb-2">
        <CardTitle className="text-base font-semibold">
          Son 30 Gün — İade Girişleri
        </CardTitle>
      </CardHeader>
      <CardContent className="pb-4">
        <ResponsiveContainer width="100%" height={280}>
          ...
          >
            <defs>
              <linearGradient id="iadeColorKullanilabilir" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#70c1aa" stopOpacity={0.3} />
                <stop offset="95%" stopColor="#70c1aa" stopOpacity={0} />
              </linearGradient>
              <linearGradient id="iadeColorKullanilamaz" x1="0" y1="0" x2="0" y2="1">
            ...
            <Area
              type="monotone"
              dataKey="kullanilabilir"
              name="Kullanılabilir"
              stroke="#70c1aa"
              strokeWidth={2}
              fill="url(#iadeColorKullanilabilir)"
            />
            <Area
              type="monotone"
              dataKey="kullanilamaz"
              name="Kullanılamaz"
              stroke="#ee7683"
              strokeWidth={2}
              fill="url(#iadeColorKullanilamaz)"
            />
          </AreaChart>
        </ResponsiveContainer>
      </CardContent>
