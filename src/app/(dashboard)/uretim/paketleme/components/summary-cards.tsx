...
import { Package, Users, Clock, TrendingUp, Loader2 } from "lucide-react";
...
export function SummaryCards() {
  ...
  useEffect(() => {
    setLoading(true);
    getAnalytics(period).then((result) => {
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <Card className="p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-muted-foreground">Toplam Paket</span>
            </div>
          ...
          <Card className="p-4">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">dk / (adet × kişi)</p>
          </Card>
        </div>
      ) : null}
    </div>
