...
import { Warehouse, AlertTriangle, Layers, Component } from "lucide-react";
import { formatNumber } from "@/lib/utils";

export interface StockKpiData {
  mamulStok: number;
  kritikUrun: number;
  yariMamulCesit: number;
  kritikHazirEleman: number;
}
...
export function StockKpiCards({ data }: { data: StockKpiData }) {
  const cards = [
    ...
    {
      title: "Kritik Ürün",
      value: formatNumber(data.kritikUrun),
      subtitle: "Eşik altında mamül",
      icon: AlertTriangle,
      iconBg: "bg-red-50",
      iconColor: "text-vw-error",
    },
    {
      title: "Yarı Mamül Çeşit",
      value: formatNumber(data.yariMamulCesit),
      subtitle: "Stokta olan parça çeşidi",
      icon: Layers,
    ...
    {
      title: "Kritik H.E.",
      value: formatNumber(data.kritikHazirEleman),
      subtitle: "Eşik altında hazır eleman",
      icon: Component,
      iconBg: "bg-amber-50",
